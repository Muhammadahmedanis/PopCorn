...
function MovieList({movieList, setMovieId, setIsHideWatchMovie, isLoader}){
    return(
...
const ShowSearchMovie = ({title, year, img, setMovieId, ind, setIsHideWatchMovie}) => {
    ...
    return(
        ...
        <div>
            <img className='h-[70px] w-[60px]' src={img ? img : "https://st2.depositphotos.com/4431055/11471/i/380/depositphotos_114715830-stock-photo-books-on-wooden-table.jpg"} alt="Error" />
            </div>
...
const Loader = () => {
    return(
        <div role="status">
            <svg aria-hidden="true" className="w-12 h-12 mx-auto mt-12 text-gray-200 animate-spin dark:text-gray-600 fill-purple-400" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
